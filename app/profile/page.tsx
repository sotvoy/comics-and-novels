    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pb-20 md:pb-4">
      ...
      <div className="px-4 pt-14 pb-4">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          ...
          <Link href="/levels" className="flex-1 py-2 bg-blue-500/20 text-blue-600 dark:text-blue-400 rounded-lg font-medium text-center flex items-center justify-center gap-1 text-sm min-w-[80px]">
            <Icons.Star className="w-4 h-4" /> Levels
          </Link>
          ...
          <Link href="/battle-pass" className="flex-1 py-2 bg-purple-500/20 text-purple-600 dark:text-purple-400 rounded-lg font-medium text-center flex items-center justify-center gap-1 text-sm min-w-[80px]">
            <Icons.BattlePass className="w-4 h-4" /> Pass
          </Link>
